// app/editor/page.js - Updated with new EditorContext
"use client"
...
export default function EditorWelcome() {
  ...
  const { setGtfsData, handleFetchData } = useEditorContext()
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      {currentProject && (
        <Card className="mb-6 border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-900/10">
          ...
          <CardContent className="pt-0">
            ...
            <div className="mt-3">
              <Button
                onClick={() => router.push("/editor/stops")}
          ...
          <DialogContent className="sm:max-w-md">
                ...
                <div className="grid gap-3">
                  <Button
                    ...
                    <div className="text-left">
                      <div className="font-medium">Upload GTFS File</div>
                      <div className="text-sm text-muted-foreground">
                        Import an existing GTFS zip file
                      </div>
                    </div>
                  </Button>
            ...
            {modalStep === "upload" && (
              <div className="space-y-4">
                <div className="space-y-3">
                  <div>
                    <Label htmlFor="uploadProjectName">Project Name *</Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="uploadProjectDescription">
                      Description (optional)
                    </Label>
                    <Input
                      id="uploadProjectDescription"
                      type="text"
      ...
      <div className="mt-12 p-6 bg-muted/30 rounded-lg">
        <h3 className="font-semibold mb-3">About GTFS</h3>
        <p className="text-sm text-muted-foreground leading-relaxed">
          The General Transit Feed Specification (GTFS) is a data specification
          that allows public transit agencies to publish their transit data in a
          format that can be consumed by a wide variety of software
          applications. Use this editor to create feeds for trip planners,
          mobile apps, and other transit tools.
        </p>
      </div>
    </div>
  )
